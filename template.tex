...
\textsc{\Large 经济统计学课程}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 企业员工离职预测及模型比较}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 指导老师：王文静}\\[0.5cm] % Minor heading such as course title
\end{center}
...
{\large 2020年6月21日}\\[2cm] % Date, change the \today to a set date if you want to be precise
