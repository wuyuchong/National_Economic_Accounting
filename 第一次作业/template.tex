...
\textsc{\Large 国民经济核算课程}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 第一次作业}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 指导老师：王会娟}\\[0.5cm] % Minor heading such as course title
\end{center}
